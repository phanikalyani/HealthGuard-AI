...
# Load and train model (simplified for demo)
...
st.markdown(" *This tool provides an AI-based risk estimate and is not a
medical diagnosis.*")
# User Inputs
...
if risk > 0.6:
st.warning("High risk detected. Consider consulting a healthcare
professional.")
else:
